...
# def extraer_naranja_pdf(archivo_pdf, tipo_documento):
#     informacion = []
...
def extraer_naranja_pdf(archivo_pdf, tipo_documento):
    pago_info = {
        ...
        "Sirtac": None,
        "Arancel": None,
        "Transferencia Electrónica": None,
        "Percepción de IVA 3.0 %": None,
        "IVA 21.0 %": None
    }

    tipo_y_numero_recuperado = False
    fecha_emision_recuperada = False
    sirtac_recuperado = False
